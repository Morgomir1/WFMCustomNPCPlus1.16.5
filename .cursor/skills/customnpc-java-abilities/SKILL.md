...
- WFM-снаряды (пуля, сеть) без моста — см. skill `wfm-cnpc-ability-bridge`.

## Дополнительно

- Полный API, параметры абилок, карта файлов: [reference.md](reference.md)
- Мост WFM↔CNPC для пуль, сетей, WFM entity: skill `wfm-cnpc-ability-bridge`
