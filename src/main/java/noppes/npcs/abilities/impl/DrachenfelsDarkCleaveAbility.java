...
public final class DrachenfelsDarkCleaveAbility implements CnpcAbility {
    public static final String ID = "drachenfels_dark_cleave";
    ...
    public Map<String, Object> defaultParams() {
        return AbilityDefaults.drachenfelsDarkCleave();
    }
    ...
    public boolean onStart(final ActiveAbility active, final AbilityContext ctx) {
        ...
        ctx.world.playSoundAt(ctx.npc.getPos(), "minecraft:entity.evoker.prepare_attack", 0.85F, 0.85F);
        return true;
    }
    ...
    private TickResult tickCharge(final ActiveAbility active, final AbilityContext ctx) {
        ...
        ctx.world.playSoundAt(ctx.npc.getPos(), "minecraft:entity.player.attack.sweep", 1.0F, 0.65F);
        return TickResult.CONTINUE;
    }
    ...
    private TickResult tickActive(final ActiveAbility active, final AbilityContext ctx) {
        ...
        final double radius = ctx.params.getDouble(AbilityParamKeys.RADIUS, 2.4);
        final double halfAngle = ctx.params.getDouble(AbilityParamKeys.CONE_HALF_ANGLE, 65.0);
        final double damage = ctx.params.getDouble(AbilityParamKeys.DAMAGE, 13.0);
    ...
    private void finishCleave(final ActiveAbility active, final AbilityContext ctx) {
        ...
        AbilityVfx.spawnPoisonFeastBurst(ctx.world, active.ex, ey, active.ez, 1.6);
